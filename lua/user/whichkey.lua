...
--               _/_/  / /_  ______ _     _/_/  __  __________  _____     _/_/  _      __/ /_  (_)____/ /_  / /_____  __  __         / /_  ______ _
--             _/_/   / / / / / __ `/   _/_/   / / / / ___/ _ \/ ___/   _/_/   | | /| / / __ \/ / ___/ __ \/ //_/ _ \/ / / /        / / / / / __ `/
--      _    _/_/    / / /_/ / /_/ /  _/_/    / /_/ (__  )  __/ /     _/_/     | |/ |/ / / / / / /__/ / / / ,< /  __/ /_/ /   _    / / /_/ / /_/ /
--     (_)  /_/     /_/\__,_/\__,_/  /_/      \__,_/____/\___/_/     /_/       |__/|__/_/ /_/_/\___/_/ /_/_/|_|\___/\__, /   (_)  /_/\__,_/\__,_/
--                                                                                                                 /____/
-- Description:  display popups with possible bindings to help the user do complex things in a few strokes.
...
if not status_ok then
  local err_msg = "Could not load properly 'which-key' inside 'whichkey.lua'"
...
-- see https://github.com/folke/which-key.nvim#-setup
local opts = {
  mode    = "n",        -- NORMAL mode
  prefix  = "<leader>",
...
local mappings = {
  ...
  B = { name =                                                                        "Buffers",
    C = { "<cmd>Telescope buffers theme=dropdown previewer=false<cr>",                          "Choose"                  },
    P = { "<cmd>BufferLinePick<cr>",                                                            "Pick"                    },
    c = { "<cmd>BufferLinePickClose<cr>",                                                       "Close"                   },
    q = { "<cmd>BufferLineGoToBuffer 1<cr>",                                                    "Go to 1"                 },
    w = { "<cmd>BufferLineGoToBuffer 2<cr>",                                                    "Go to 2"                 },
    e = { "<cmd>BufferLineGoToBuffer 3<cr>",                                                    "Go to 3"                 },
    r = { "<cmd>BufferLineGoToBuffer 4<cr>",                                                    "Go to 4"                 },
    t = { "<cmd>BufferLineGoToBuffer 5<cr>",                                                    "Go to 5"                 },
    y = { "<cmd>BufferLineGoToBuffer 6<cr>",                                                    "Go to 6"                 },
    u = { "<cmd>BufferLineGoToBuffer 7<cr>",                                                    "Go to 7"                 },
    i = { "<cmd>BufferLineGoToBuffer 8<cr>",                                                    "Go to 8"                 },
    o = { "<cmd>BufferLineGoToBuffer 9<cr>",                                                    "Go to 9"                 },
    p = { "<cmd>BufferLineGoToBuffer 10<cr>",                                                   "Go to 1O"                },
                                                                                                                          },
  p = { name =                                                                         "Packer",
  ...
  C = { name =                                                                         "CONFIG",
    l = { "<cmd>lua _CFG_LAZYGIT_TOGGLE()<CR>",                                                 "Lazygit"                 },
    t = { "<cmd>lua _CFG_TIG_TOGGLE()<CR>",                                                     "Tig"                     },
                                                                                                                          },
  l = { name =                                                                            "LSP",
