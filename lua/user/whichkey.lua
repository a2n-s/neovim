...
local mappings = {
  ...
  b = { name =                                                                        "Buffers",
    ...
    c = { "<cmd>BufferLinePickClose<cr>",                                                       "Close any"               },
    k = { "<cmd>Bdelete!<CR>",                                                                  "Close current"           },
    N = { ":ene<CR>",                                                                           "New empty buffer"        },
    s = { "<cmd>w!<CR>",                                                                        "Save"                    },
    S = { "<cmd>wa!<CR>",                                                                       "Save all"                },
    g = { "<cmd>Telescope buffers theme=dropdown previewer=false<cr>",                          "Go to"                   },
